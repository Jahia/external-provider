...
<script type="text/ng-template" id="treeItem.html">
    <input name="{{propName}}" type="radio" ng-if="isFolder(item)" ng-model="selectedPath" ng-value="item.path"
           ng-disabled="!enablePicker"/>&nbsp;
...
<div class="checkbox">
    <label ng-if="hideAndCheckbox">
        <input type="checkbox" ng-model="enablePicker" ng-click="switchPicker()" class="sitecheckbox"/>&nbsp;{{selectMessage}}
    </label>
</div>
