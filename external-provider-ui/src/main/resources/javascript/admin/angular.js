 ...
 */
    function makeMap(str) {
        var obj = {}; var items = str.split(','); var
            i;
 ...
 */
    function equals(o1, o2) {
        ...
        var t1 = typeof o1; var t2 = typeof o2; var length; var key; var keySet;
        if (t1 == t2) {
            if (t1 == 'object') {
                if (isArray(o1)) {
                    if (!isArray(o2)) {
    ...
    var csp = function () {
        ...
        var active = Boolean(document.querySelector('[ng-csp]') ||
 ...
 */
    function angularInit(element, bootstrap) {
        ...
        var appElement;
        var module;
        var names = ['ng:app', 'ng-app', 'x-ng-app', 'data-ng-app'];
 ...
 */
    ...
    function jqLitePatchJQueryRemove(name, dispatchThis, filterElems, getterIfNoArguments) {
        ...
        function removePatch(param) {
            ...
            var fireEvent = dispatchThis;
            var set; var setIndex; var setLength;
            var element; var childIndex; var childLength; var children;
    ...
    function jqLiteBuildFragment(html, context) {
        var elem; var tmp; var tag; var wrap;
        var fragment = context.createDocumentFragment();
        var nodes = []; var i; var j; var jj;
    ...
    function jqLiteRemoveData(element, name) {
        ...
        var expandoStore = jqCache[expandoId];
    ...
    function jqLiteExpandoStore(element, key, value) {
        var expandoId = element.ng339;
        var expandoStore = jqCache[expandoId || -1];
    ...
    function jqLiteData(element, key, value) {
        ...
        var isSetter = isDefined(value);
        var keyDefined = !isSetter && isDefined(key);
   ...
   */
    ...
    forEach({
        ...
        triggerHandler: function (element, event, extraParameters) {
            var dummyEvent; var eventFnsCopy; var handlerArgs;
 ...
 */
    ...
    function createInjector(modulesToLoad) {
        ...
        function loadModules(modulesToLoad) {
            var runBlocks = []; var moduleFn; var invokeQueue; var i; var ii;
        ...
        function createInternalInjector(cache, factory) {
            ...
            function instantiate(Type, locals) {
                ...
                var instance; var returnedValue;
 ...
 */
   ...
   */
        self.cookies = function (name, value) {
            ...
            var cookieLength; var cookieArray; var cookie; var i; var index;
 ...
 */
    ...
    function $CompileProvider($provide, $$sanitizeUriProvider) {
        ...
        var CLASS_DIRECTIVE_REGEXP = /(([\d\w_\-]+)(?:\:([^;]+))?;?)/;
   ...
   */
       ...
       */
                    $observe: function (key, fn) {
                        var attrs = this;
                        var $$observers = (attrs.$$observers || (attrs.$$observers = {}));
     ...
     */
                function compileNodes(nodeList, transcludeFn, $rootElement, maxPriority, ignoreDirective,
                    previousCompileContext) {
                    var linkFns = [];
                    var attrs; var directives; var nodeLinkFn; var childNodes; var childLinkFn; var linkFnFound;
                    ...
                    function compositeLinkFn(scope, nodeList, $rootElement, parentBoundTranscludeFn) {
                        var nodeLinkFn; var childLinkFn; var node; var childScope; var i; var ii; var n; var childBoundTranscludeFn;

                        // Copy nodeList so that linking doesn't break due to live list updates.
                        var nodeListLength = nodeList.length;
                        var stableNodeList = new Array(nodeListLength);
     ...
     */
                ...
                jqLite(document.createComment(' ' + directiveName + ': ' +
                    ...
                    function getControllers(directiveName, require, $element, elementControllers) {
                        var value; var retrievalMethod = 'data'; var
                            optional = false;
                        if (isString(require)) {
                    ...
                    function nodeLinkFn(childLinkFn, scope, linkNode, $rootElement, boundTranscludeFn) {
                        var attrs; var $element; var i; var ii; var linkFn; var controller; var isolateScope; var elementControllers = {}; var
                            transcludeFn;
              ...
              templateDirective === newIsolateScopeDirective.$$originalDirective)) {
                            ...
                            forEach(newIsolateScopeDirective.scope, function (definition, scopeName) {
                                ...
                                var mode = match[1]; // @, =, or &
                                var lastValue;
                                var parentGet; var parentSet; var compare;
     ...
     */
                ...
                function compileTemplateUrl(directives, $compileNode, tAttrs,
                    ...
                    var derivedSyncDirective = extend({}, origAsyncDirective, {
                    ...
                    $http.get($sce.getTrustedResourceUrl(templateUrl), {cache: $templateCache})
                        .success(function (content) {
                            var compileNode; var tempTemplateAttrs; var $template; var childBoundTranscludeFn;
                    ...
                    if (interpolateFn) {
                        directives.push({
                            ...
                            compile: function textInterpolateCompileFn(templateNode) {
                                ...
                                var parent = templateNode.parent(); var
                                ...
                                return function textInterpolateLinkFn(scope, node) {
                                    ...
                                    var bindings = parent.data('$binding') || [];
   ...
   */
     ...
     */
            return function (expression, locals) {
                var instance; var match; var constructor; var identifier;
 ...
 */
    function parseHeaders(headers) {
        var parsed = {}; var key; var val; var i;
     ...
     */
                function $http(requestConfig) {
                    ...
                    function mergeHeaders(config) {
                        ...
                        var defHeaderName; var lowercaseDefHeaderName; var reqHeaderName;
 ...
 */
    ...
    function createHttpBackend($browser, createXhr, $browserDefer, callbacks, rawDocument) {
        ...
        function jsonpReq(url, callbackId, done) {
            ...
            var script = rawDocument.createElement('script'); var
                callback = null;
   ...
   */
        ...
        this.$get = ['$rootScope',
            ...
            function ($rootScope, $browser, $sniffer, $rootElement) {
                var $location;
                var LocationMode;
                var baseHref = $browser.baseHref(); // If base[href] is undefined, it defaults to ''
 ...
 */
    ...
    Lexer.prototype = {
        ...
        readIdent: function () {
            ...
            var lastDot; var peekIndex; var methodName; var ch;
 ...
 */
    ...
    Parser.prototype = {
        ...
        parse: function (text) {
            ...
            value.literal = Boolean(value.literal);
        ...
        primary: function () {
            ...
            if (this.expect('(')) {
                ...
                primary.literal = Boolean(token.literal);
                primary.constant = Boolean(token.constant);
            }

            var next; var context;
 ...
 */
   ...
   */
        this.unwrapPromises = function (value) {
            if (isDefined(value)) {
                $parseOptions.unwrapPromises = Boolean(value);
                return this;
            }
   ...
   */
    ...
    function $$RAFProvider() { // RAF
        this.$get = ['$window', '$timeout', function ($window, $timeout) {
            ...
            var rafSupported = Boolean(requestAnimationFrame);
 ...
 */
     ...
     */
      ...
      */
       ...
       */
                    $watchCollection: function (obj, listener) {
                        ...
                        function $watchCollectionWatch() {
                            ...
                            var newLength; var key; var bothNaN;
       ...
       */
                    $digest: function () {
                        var watch; var value; var last;
                        var watchers;
                        var asyncQueue = this.$$asyncQueue;
                        var postDigestQueue = this.$$postDigestQueue;
                        var length;
                        var dirty; var ttl = TTL;
                        var next; var current; var target = this;
                        var watchLog = [];
                        var logIdx; var logMsg; var asyncTask;
       ...
       */
                    $broadcast: function (name, args) {
                        ...
                        var listenerArgs = concat([event], arguments, 1);
                        var listeners; var i; var length;
   ...
   */
        ...
        this.$get = ['$injector', function ($injector) {
            ...
            function matchUrl(matcher, parsedUrl) {
                ...
                return Boolean(matcher.exec(parsedUrl.href));
            }
        ...
        this.$get = ['$window', '$document', function ($window, $document) {
          ...
          int((/android (\d+)/.exec(lowercase(($window.navigator || {}).userAgent)) || [])[1]);
            ...
            if (bodyStyle) {
                ...
                transitions = Boolean(('transition' in bodyStyle) || (vendorPrefix + 'Transition' in bodyStyle));
                animations = Boolean(('animation' in bodyStyle) || (vendorPrefix + 'Animation' in bodyStyle));
            ...
            return {
                ...
                // jshint -W018
                history: Boolean($window.history && $window.history.pushState && !(android < 4) && !boxee),
                // jshint +W018
 ...
 */
    ...
    function formatNumber(number, pattern, groupSep, decimalSep, fractionSize) {
        ...
        if (!hasExponent) {
            ...
            number = Number(Math.round(Number(number.toString() + 'e' + fractionSize)).toString() + 'e' + -fractionSize);
            ...
            var i; var pos = 0;
            var lgroup = pattern.lgSize;
            var group = pattern.gSize;
            ...
            return {
                ...
                link: function (scope, element, attr) {
                    scope.$watch(attr[normalized], function ngBooleanAttrWatchAction(value) {
                        attr.$set(attrName, Boolean(value));
                    });
                }
            };
        };
 ...
 */
    ...
    function FormController(element, attrs, $scope, $animate) {
        ...
        var invalidCount = 0; // Used to easily determine if we are valid
...
*/
   ...
   */
    ...
    function textInputType(scope, element, attr, ctrl, $sniffer, $browser) {
        ...
        var placeholder = element[0].placeholder; var
            noevent = {};
    ...
    function numberInputType(scope, element, attr, ctrl, $sniffer, $browser) {
        ...
        ctrl.$formatters.push(function (value) {
            return ctrl.$isEmpty(value) ? '' : String(value);
        });
    ...
    function checkboxInputType(scope, element, attr, ctrl) {
        ...
        var falseValue = attr.ngFalseValue;
    ...
    var ngListDirective = function () {
        return {
            ...
            link: function (scope, element, attr, ctrl) {
                ...
                var separator = match && new RegExp(match[1]) || attr.ngList || ',';
                    ...
                    function digestClassCounts(classes, count) {
                        ...
                        forEach(classes, function (className) {
                            if (count > 0 || classCounts[className]) {
                                ...
                                if (classCounts[className] === Number(count > 0)) {
    ...
    var ngIfDirective = ['$animate', function ($animate) {
        return {
            ...
            link: function ($scope, $element, $attr, ctrl, $transclude) {
                var block; var childScope; var previousElements;
    ...
    var ngRepeatDirective = ['$parse', '$animate', function ($parse, $animate) {
        ...
        return {
            ...
            link: function ($scope, $element, $attr, ctrl, $transclude) {
                ...
                var trackByExp; var trackByExpGetter; var trackByIdExpFn; var trackByIdArrayFn; var trackByIdObjFn;
                var lhs; var rhs; var valueIdentifier; var keyIdentifier;
                ...
                $scope.$watchCollection(rhs, function ngRepeatAction(collection) {
                    ...
                    var previousNode = $element[0]; // Current position of the node
                    var nextNode;
                    ...
                    var arrayLength;
                    var childScope;
                    var key; var value; // Key/value of iteration
                    var trackById;
                    var trackByIdFn;
                    var collectionKeys;
 ...
 */
    ...
    var selectDirective = ['$compile', '$parse', function ($compile, $parse) {
        ...
        var nullModelCtrl = {$setViewValue: noop};
        // jshint maxlen: 100
        ...
        return {
            ...
            link: function (scope, element, attr, ctrls) {
                ...
                var nullOption = false; // If false, user will not be able to select it (used by ngOptions)
                var emptyOption;
                ...
                var unknownOption = optionTemplate.clone();
            ...
            ' but got \'{0}\'. Element: {1}',
                    ...
                    selectElement.on('change', function () {
                        scope.$apply(function () {
                            ...
                            var locals = {};
                            var key; var value; var optionElement; var index; var groupIndex; var length; var groupLength; var trackIndex;
                    ...
                    function render() {
                        ...
                        var optionGroup;
                        var option;
                        var existingParent; var existingOptions; var existingOption;
                        var modelValue = ctrl.$modelValue;
                        var values = valuesFn(scope) || [];
                        var keys = keyName ? sortedKeys(values) : values;
                        var key;
                        var groupLength; var length;
                        var groupIndex; var index;
                        var locals = {};
                        var selected;
