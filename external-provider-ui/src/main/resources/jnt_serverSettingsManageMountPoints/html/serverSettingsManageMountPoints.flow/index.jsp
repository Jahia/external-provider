        ...
        <tr>
            ...
            <td>
                <c:if test="${mountPoint.showMountAction}">
                    <button class="btn btn-info" type="button" onclick="submitEvent('MOUNT', '${fn:escapeXml(functions:escapeJavaScript(mountPoint.realName))}')">
                ...
                <c:if test="${mountPoint.showUnmountAction}">
                    <button class="btn btn-info" type="button" onclick="submitEvent('UNMOUNT', '${fn:escapeXml(functions:escapeJavaScript(mountPoint.realName))}')">
